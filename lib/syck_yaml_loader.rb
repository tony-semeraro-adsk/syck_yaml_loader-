...
require "version"
require 'stringio'
require 'syck_yaml_loader.so'
require 'syck_yaml_loader/error'
require 'syck_yaml_loader/syck_yaml_loader'
require 'syck_yaml_loader/tag'
require 'syck_yaml_loader/stream'
require 'syck_yaml_loader/constants'
require 'syck_yaml_loader/rubytypes'
require 'syck_yaml_loader/types'
...
module SyckYamlLoader
    ...
    def self.dump( obj, io = nil )
        obj.syck_to_yaml( io || io2 = StringIO.new )
